...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "UK charities warned after Haiti sex claims / Ellerium Start";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1518349330;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 20608653;
        ...
        vSeeds.push_back(CDNSSeedData("elleriumdns1.steeppool.com", "elleriumdns1.steeppool.com"));
