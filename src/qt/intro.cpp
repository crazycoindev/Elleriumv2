...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Ellerium Core"),
     ...
     * override -datadir in the ellerium.conf file in the default data directory
     * (to be consistent with elleriumd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
