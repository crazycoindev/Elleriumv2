...
/** Utility functions used by the Ellerium Qt UI.
 */
namespace GUIUtil
{
...
// Render Ellerium addresses in monospace font
...
// Parse "ellerium:" URI into recipient object, return true on successful parsing
