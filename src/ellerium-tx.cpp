...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ellerium Core ellerium-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ellerium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ellerium transaction") + "\n" +
                               "  ellerium-tx [options] -create [commands]   " + _("Create hex-encoded ellerium transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ellerium transaction
