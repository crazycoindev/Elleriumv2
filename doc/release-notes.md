Ellerium Core version 2.2.1 is now available from:

  <https://github.com/ellerium-project/ellerium/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/ellerium-project/ellerium/issues>

Compatibility
==============

Ellerium Core is extensively tested on multiple operating systems using
...
Ellerium Core should also work on most other Unix-like systems but is not
...
of Bitcoin that Ellerium was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/ellerium-project-translations/).
