...
In order to support loading of multiple wallets in ellerium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ellerium.cpp.
...
Changes to ellerium.cpp
----------------------
ellerium.cpp is the entry point into ellerium-qt, and as such, will require some minor modifications to provide hooks for
