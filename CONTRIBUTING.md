Contributing to Ellerium Core
============================

The Ellerium Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Ellerium Core project, and is not to be
confused with overall Ellerium Network Protocol consensus changes.

Whether a pull request is merged into Ellerium Core rests with the project merge
...
Patches that change Ellerium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Ellerium consensus, it must have been
...
The project leader is the release manager for each Ellerium Core release.
